...
function LoginForm() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-apricot-light via-cream to-white flex items-center justify-center p-4">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-chartreuse/20 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-vista-blue/20 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <Card3D variant="glass" padding="lg">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Sign in to continue booking courts</p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-white/80 text-sm text-gray-500">Or continue with</span>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-8">
            ...
            <Link href="/signup" className="text-tomato hover:text-tomato-dark font-semibold">
              Sign up for free
            </Link>
          </p>
        </Card3D>
